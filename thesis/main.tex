...
\documentclass[type=master,theme=default,language=english,titlelanguage=english,smartquotes=true]{hgbthesis}
...
\title{How can the generation of height maps by MESA be controlled to ensure realistic and geographically accurate landscapes?}

...
\documentclass[type=bachelor,theme=default,language=english,titlelanguage=english,smartquotes=true]{hgbthesis}
...
\title{How can the generation of heightmaps by MESA be controlled to ensure realistic and geographically accurate landscapes?}
...
\dateofsubmission{2026}{05}{27} % {YYYY}{MM}{DD}

% List of advisors, up to 4 are possible, title in [] is optional
\advisor{FH-Prof. Dr., BSc MSc David Christian Schedl}

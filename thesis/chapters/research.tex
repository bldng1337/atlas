...
Thermal Erosion models gradual breakdown and redistribution of terrain material. The initial model, introduced by Musgrave et al.~\cite{musgrave1989synthesis} operates by comparing the altitude difference of each vertex with its neighboring vertices. If the slope is too steep, a fixed percentage gets transferred to the neighbor.

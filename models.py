...
class UNetDEMConditionModel(
    ...
    def forward(
        ...
        # Convert to list for pop operations if adapter residuals are provided
        if is_adapter:
        ...
        if (
            ...
            sample_dem, res_samples_dem = self.head_img(
        ...
        if (
            hasattr(self.head_out_img, "has_cross_attention")
            and self.head_out_img.has_cross_attention
        ):
        ...
        if (
            hasattr(self.head_out_dem, "has_cross_attention")
            and self.head_out_dem.has_cross_attention
        ):
        ...
        if block == "down_blocks":
            ...
            if block_num == 0:
                ...
                new_name = name.replace(
                    f"down_blocks.{block_num}", f"down_blocks.{block_num - 1}"
                )
